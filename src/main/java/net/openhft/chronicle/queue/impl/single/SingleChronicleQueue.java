...
public class SingleChronicleQueue implements RollingChronicleQueue {
    ...
    private static final boolean REUSE_POOL = Boolean.getBoolean("reuse.pool");
...
//                    sb.append("# ").append(wireStore.bytes().mappedFile().file()).append("\n");
    ...
    protected ExcerptAppender newAppender() {
        final WireStorePool newPool = REUSE_POOL ? pool : WireStorePool.withSupplier(new StoreSupplier(), storeFileListener);
